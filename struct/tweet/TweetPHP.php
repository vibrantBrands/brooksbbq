<?php
 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      array(
          'consumer_key'          => 'bjWF3Btq9YItaHatF3poIOjO1',
          'consumer_secret'       => 'FbmXNBh2kHfgTeaodjZ5zgyaeaznsleeGxFY2pi6QPiNYyPm45',
          'access_token'          => '14572923-kAU6fXCagWCuTzNKazQGcWElGDYseWHBqPQgBfiP8',
          'access_token_secret'   => 'zPyh5ft4eq3rYVznqDgh3uJZFDEQCDU2WZZfPgJu4kTMB',
          'twitter_screen_name'   => 'Ind_Res_Inc',
          'enable_cache'          => true,
          'cache_dir'             => dirname(__FILE__) . '/cache/', // Where on the server to save cached tweets
          'cachetime'             => 60 * 60, // Seconds to cache feed (1 hour).
          'tweets_to_retrieve'    => 5, // Specifies the number of tweets to try and fetch, up to a maximum of 200
          ...
          'tweet_template'        => '<li><span class="status">{tweet}</span></li>',
